$(document).ready(function() {
	...
	var saveEditedImage = function(item) {
		...
		// send request
		if (item.appended) {
			$.post('/admin/manufacturing/editimage', {_file: item.file, _editor: JSON.stringify(item.editor), fileuploader: 1}, function() {
	...
	$('input[name="files"]').fileuploader({
		...
		upload: {
            url: '/admin/manufacturing/upload',
            data: null,
            type: 'POST',
		...
		onRemove: function(item) {
			$.post('/admin/manufacturing/delimage', {
				file: item.name
			});
		},
		editor: {
