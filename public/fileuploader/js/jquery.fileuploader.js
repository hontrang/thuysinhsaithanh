			...
			var s = $(r), // input element
				...
				f = {
					...
					editor: {
                         ...
                         * @void
                         */
						save: function(item, toBlob, callback, preventThumbnailRender) {
							var inPopup = item.popup && typeof item.popup.html !== "undefined";
							...
							var type = item.type || 'image/jpeg',
								...
								nextStep = function(exportDataUrl, img) {
									...
									inPopup && !preventThumbnailRender ? f.thumbnails.renderThumbnail(item, true, img || exportDataUrl) : null;
						...
						add: function(file, prop) {
							...
							if (n.editor && format == 'image')
								item.editor = {
									...
									save: function(callback, toBlob, preventThumbnailRender) {
										f.editor.save(item, toBlob, callback, preventThumbnailRender);
									}
								};
