...
$config = array(
    ...
    */
    ...
    'access_keys' => array('datnguyen2017'),
    ...
    *******************/
    ...
    'fixed_path_from_filemanager'             => array( '../small/' ), //fixed path of the image folder from the current position on upload folder
    ...
    'fixed_image_creation_width'              => array(350), //width of image
    'fixed_image_creation_height'             => array(350), //height of image
    /*
    #             $option:     0 / exact = defined size;
    #                          1 / portrait = keep aspect set height;
    #                          2 / landscape = keep aspect set width;
