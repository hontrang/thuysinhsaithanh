                    ...
                    if(isset($list))
                        foreach($list as $item)
                        {
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo base_url('public/userfiles/'.$item->image);?>" width="150px"> </td>
                                <td><?php echo $item->name;?></td>
                                <td><?php echo $item->view;?></td>
                                <td>
                                    <div style="margin-bottom: 3px"><a href="<?php echo base_url('admin/'.$current_module.'/edit/'.$item->id);?>"><button class="btn btn-warning btn-sm " type="button"><i class="fa fa-edit"></i>&nbsp;Sửa</button></a> <a href="<?php echo base_url('admin/'.$current_module.'/addimage/'.$item->id);?>"><button class="btn btn-success btn-sm " type="button"><i class="fa fa-picture-o"></i>&nbsp;Thêm hình ảnh</button></a>
                                   <button  onclick="remove('/admin/<?php echo $current_module;?>/del/<?php echo $item->id;?>');" class="btn btn-danger btn-danger btn-sm" type="button"><i class="fa fa-trash"></i>&nbsp;Xóa</button> </div>
                                </td>
                            </tr>
