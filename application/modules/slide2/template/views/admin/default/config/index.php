                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?php if($item->type == "0"){ ?>
                                ...
                                <?php if($item->k == "hotline_en" or $item->k == "hotline_vi" or $item->k == "logo" or $item->k == "logo_en" or $item->k == "nen-1" or $item->k == "nen-2" or $item->k == "nen-3" or $item->k == "nen-4"or $item->k == "video-banner" or $item->k == "image-banner" or $item->k == "block-3---image"){?>
