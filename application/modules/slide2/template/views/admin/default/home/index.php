                    ...
                    if(isset($listbooking))
                        foreach($listbooking as $item)
                        {
                            ...
                            <tr>
                                ...
                                <td><?php echo $item->date_booking;?></td>
                                <td><?php echo date("d/m/Y H:i:s", strtotime($item->create_date));?></td>
                                <td><?php if($item->view == 0)echo "Chưa xem";else echo "Đã xem";?></td>
                                <td>
                                    <div style="margin-bottom: 3px"><a href="<?php echo base_url('admin/customer/bookingview/'.$item->id);?>"><button class="btn btn-warning btn-sm " type="button"><i class="fa fa-eye"></i>&nbsp;Xem</button></a>
                                        <button  onclick="remove('/admin/customer/bookingdel/<?php echo $item->id;?>');" class="btn btn-danger btn-danger btn-sm" type="button"><i class="fa fa-trash"></i>&nbsp;Xóa</button> </div>
                                </td>
                            </tr>
