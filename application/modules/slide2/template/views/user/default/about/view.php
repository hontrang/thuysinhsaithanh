    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 sidebar">
                <div class="cr_title_green_main">
                    <div style="padding-top: 7px;">
                        <div class="cr_title_green cr_title_green_main_text"><h2><?php echo $this->lang->line('about');?></h2></div>
                        <div class="cr_title_triangle"></div>
                    </div>
                </div>
                <div class="list-item row">
                    <?php if(isset($list))foreach ($list as $item){ ?>
                        <div class="col-sm-12 hvr-forward">
                            <a href="<?php echo site_url('gioi-thieu/'.$item->slug.'-'.$item->id);?>" title="<?php echo $item->name;?>">
                                <img class="menu-icon" src="/public/userfiles/logo-icon.png" />
                                <span><?php echo $item->name;?></span> </a>
                        </div>
                    <?php } ?>
                </div>
