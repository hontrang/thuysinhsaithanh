    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="news-item row">
                        <?php if(isset($list_item)) foreach ($list_item as $item) {?>
                            <div class="col-sm-12 col-xs-12">
                                <a href="<?php echo site_url('co-so-vat-chat/'.$item->slug.'-'.$item->id);?>">
                                    <div class="col-md-3 img-box">
                                        <img class="scale" alt="<?php echo $item->name;?>" src="<?php echo base_url('public/small/'.$item->image);?>">
                                    </div>
                                </a>
                                <div class="col-md-9">
                                    <a href="<?php echo site_url('co-so-vat-chat/'.$item->slug.'-'.$item->id);?>"><h5><?php echo $item->name;?></h5></a>
            ...
            <div class="col-lg-4 sidebar">
                <div class="cr_title_green_main">
                    <div style="padding-top: 7px;">
                        <div class="cr_title_green cr_title_green_main_text"><h2><?php echo $this->lang->line('service');?></h2></div>
                        <div class="cr_title_triangle"></div>
                    </div>
                </div>
