            ...
            <div class="ibox-content">
                <form method="POST" action="" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea  name="detail" rows="10" class="form-control"><?php echo set_value('detail',$info->detail)?></textarea>
