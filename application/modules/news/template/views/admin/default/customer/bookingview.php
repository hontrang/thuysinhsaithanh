    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-content">
                <form method="POST" action="/admin/customer/booking.html" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="address" value="<?php echo $info->age;?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="address" value="<?php if($info->sex == 0)echo "Nữ"; else echo "Nam";?>" class="form-control">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-2 control-label">Thời gian muốn khám:</label>

                        <div class="col-md-10">
                            <input type="text" name="address" value="<?php echo $info->date_booking; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Bác sỹ:</label>

                        <div class="col-md-10">
                            <input type="text" name="address" value="<?php if(isset($doctor->name)) echo $doctor->name; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="department" value="<?php if(isset($department->name)) echo $department->name; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" rows="15"><?php if(isset($info->note))echo  $info->note;?></textarea>
                        </div>
                    </div>
