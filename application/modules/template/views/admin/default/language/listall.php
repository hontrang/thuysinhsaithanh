                    ...
                    if(isset($list))
                        foreach($list as $item)
                        {
                            ...
                            <tr>
                                ...
                                <td><?php echo $item->key;?><div style="display:none"><?php echo $item->text;?></div></td>
                                <td><?php echo $item->language;?></td>
                                <td><input style="width: 100%" class="form-control" id="id-<?php echo $item->id;?>" value="<?php echo $item->text;?>" /> </td>
                                <td>
                                    <div>
                                        <button class="btn btn-primary btn-sm btn-save" data-id="<?php echo $item->id;?>" type="button"><i class="fa fa-edit"></i>&nbsp;Lưu</button>
                                        <button class="btn btn-danger btn-sm btn-trash" data-id="<?php echo $item->id;?>" type="button"><i class="fa fa-trash"></i>&nbsp;Xóa</button>
