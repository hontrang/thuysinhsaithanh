                ...
                <form method="POST" action="" class="form-horizontal">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Hình ảnh (<span class="required">*</span>):</label>
                        <div class="col-sm-10">
                            ...
                            <span>Ghi chú: hình ảnh nên có kích thước 450x253px.</span>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea  name="description" rows="10" class="form-control textmini"><?php echo set_value('description')?></textarea>
