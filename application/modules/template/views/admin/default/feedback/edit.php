            ...
            <div class="ibox-content">
                <form method="POST" action="" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-md-2 control-label">Tên Khách hàng (<span class="required">*</span>):</label>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Nghề nghiệp (<span class="required">*</span>):</label>

                        <div class="col-md-8">
                            <input type="text" name="work" value="<?php echo set_value('work',$info->work)?>" class="form-control">
                            <?php echo form_error('work', '<div class="error">', '</div>'); ?>
                        </div>
                    </div>

                    <div class="form-group"><label class="col-sm-2 control-label">Hình ảnh (<span class="required">*</span>):</label>
                        <div class="col-sm-10">
                            <div class="input-group"><input id="post_image" name="image" type="text" class="form-control" value="<?php echo set_value('image',$info->image)?>"> <span class="input-group-btn"><button onclick="open_popup('/public/filemanager/dialog.php?type=1&popup=1&field_id=post_image&akey=datnguyen2017&relative_url=1&fldr=feedback_avatar/')" type="button" class="btn btn-w-m btn-primary">Tải và Chọn file ảnh từ thư viện</button></span></div>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Ý kiến khách hàng (<span class="required">*</span>):</label>

                        <div class="col-md-8">
                            <input type="text" name="comment" value="<?php echo set_value('comment',$info->comment)?>" class="form-control">
