            ...
            <div class="ibox-content">
                <form method="POST" action="" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="sub_name" value="<?php echo set_value('sub_name')?>" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea name="des" rows="5" class="form-control"><?php echo set_value('des')?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea name="detail" rows="10" class="form-control fulleditor"><?php echo set_value('detail')?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea name="vitri" rows="10" class="form-control fulleditor"><?php echo set_value('vitri')?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea name="matbang" rows="10" class="form-control fulleditor"><?php echo set_value('matbang')?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea name="tienich" rows="10" class="form-control fulleditor"><?php echo set_value('tienich')?></textarea>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea name="phuongthucthanhtoan" rows="10" class="form-control fulleditor"><?php echo set_value('phuongthucthanhtoan')?></textarea>
