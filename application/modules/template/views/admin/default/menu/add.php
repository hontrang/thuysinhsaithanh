            ...
            <div class="ibox-content">
                <form method="POST" action="" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <label class="checkbox-inline "> <input type="radio" name="target" value="_self" checked> Cùng cửa sổ</label>
                            <label class="checkbox-inline "> <input type="radio" name="target" value="_blank"> Cửa sổ mới</label>
                        </div>
                    </div>
