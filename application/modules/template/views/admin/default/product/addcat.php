            ...
            <div class="ibox-content">
                <form method="POST" action="" class="form-horizontal">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" name="parent_id">
                                ...
                                <?php if(isset($listparent))foreach ($listparent as $parent){
                                    ?>
                                    <option value="<?php echo $parent->id;?>" <?php echo set_select("parent_id", $parent->id);?>><?php echo $parent->name;?></option>
									<?php $subs = $this->MCommon->getAllRowByWhere_lang('vi','product_cat',['parent_id'=>$parent->id]);
										if($subs)foreach ($subs as $sub){
									?>
										<option value="<?php echo $sub->id;?>" <?php echo set_select("parent_id", $sub->id);?>>---- <?php echo $sub->name;?></option>
									<?php } ?>
                                <?php } ?>
                            </select>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="color" value="<?php echo set_value('color','#176EB4')?>" class="form-control colorpicker">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="number" name="discount" value="<?php echo set_value('discount',0)?>" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <label class="checkbox-inline i-checks"> <input type="checkbox" name="show_home" value="1"> </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="ads_url" value="<?php echo set_value('ads_url')?>" class="form-control">
