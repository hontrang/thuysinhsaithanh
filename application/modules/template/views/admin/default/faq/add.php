                ...
                <form method="POST" action="" class="form-horizontal">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Image (<span class="required">*</span>):</label>
                        <div class="col-sm-10">
                            ...
                            <span>Lưu ý: Hình ảnh nên có kích thước 280x180px.</span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea id="news" name="content" rows="10" class="form-control"><?php echo set_value('content')?></textarea>
