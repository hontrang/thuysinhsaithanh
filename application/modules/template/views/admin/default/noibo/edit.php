        ...
        <div class="col-lg-12">
            <div class="ibox-content">
                <form method="POST" action="" class="form-horizontal">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">File đính kèm :</label>
                        <div class="col-sm-10">
                            <div class="input-group"><input id="post_image" name="file" type="text" class="form-control" value="<?php echo set_value('file',$info->file)?>"> <span class="input-group-btn"><button onclick="open_popup('/public/filemanager/dialog.php?popup=1&field_id=post_image&akey=datnguyen2017&relative_url=1&fldr=<?php echo $module;?>/')" type="button" class="btn btn-w-m btn-primary">Tải và Chọn file ảnh từ thư viện</button></span></div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" >Chi tiết (<span class="required">*</span>):</label>
                        <div class="col-md-10">
