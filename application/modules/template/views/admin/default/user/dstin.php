                    ...
                    if(isset($listBDS)){
                        foreach($listBDS as $item)
                        {
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo base_url($item->default_image);?>" height="80px" /></td>
                                ...
                                <td><a href="/admin/user/chitiettin/<?php echo $item->id;?>"><button class="btn btn-warning btn-sm" type="button"><i class="fa fa-edit"></i>&nbsp;Chi tiết</button></a>
                                    <a href="/admin/user/huyduyet/<?php echo $item->id;?>"><button class="btn btn-warning btn-sm"" type="button"><i class="fa fa-edit"></i>&nbsp;Hủy duyệt</button></a>
                                    <button  onclick="remove('/admin/user/xoatin/<?php echo $item->id;?>');" class="btn btn-danger btn-danger btn-sm"" type="button"><i class="fa fa-trash"></i>&nbsp;Xóa</button></td>
                            </tr>
                            <?php
                        }
                    }
