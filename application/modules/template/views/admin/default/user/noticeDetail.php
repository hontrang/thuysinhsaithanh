 ...
 * Last Modified: 8/28/17 4:01 PM
 * Date: 8/29/17 9:34 AM
 *
 */
            ...
            <div class="ibox-content animated fadeInRight">
                ...
                <div class="" style="max-width: 1000px; margin: auto;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="detail" class="form-control"><?php echo set_value('title')?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="type" id="post_groupid" class="form-control input-sm">
                                    ...
                                    <option value="2" <?php echo  set_select('type',2); ?>>Gửi qua email</option>
                                </select>
