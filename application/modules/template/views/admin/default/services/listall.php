            ...
            <div class="ibox-content">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th>Hình ảnh</th>
                        <th>Tên</th>
						<th class="text-center">Hiện ở trang chủ</th>
                        <th>Lượt xem</th>
                        <th>Thao tác</th>
                    </tr>
                    </thead>
                    ...
                    if(isset($list))
                        foreach($list as $item)
                        {
                            ...
                            <tr>
								...
								<td class="text-center"><input onclick="set_status('show_home','<?php echo $item->id;?>','services');" type="checkbox" <?php if($item->show_home=="1")echo 'checked="checked"';?></td>
