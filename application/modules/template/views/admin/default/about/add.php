            ...
            <div class="ibox-content">
                <form method="POST" action="" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea name="des" rows="5" class="form-control editor_full"><?php echo set_value('des')?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea id="news" name="content" rows="10" class="form-control editor_full"><?php echo set_value('content')?></textarea>
