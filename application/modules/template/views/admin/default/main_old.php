...
<head>
    ...
    <link href="<?php echo base_url();?>/public/fileupload/css/jquery.fileupload.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="<?php echo base_url();?>public/datepicker/css/bootstrap-datepicker3.min.css" type="text/css" media="screen" />
...
<body class="fixed-sidebar">
    ...
    <script type="text/javascript" src="<?php echo base_url();?>public/datepicker/js/bootstrap-datepicker.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>public/datepicker/locales/bootstrap-datepicker.vi.min.js"></script>
