                ...
                <form method="POST" action="" class="form-horizontal">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Image (<span class="required">*</span>):</label>
                        <div class="col-sm-10">
                            ...
                            <span>Lưu ý: Hình ảnh nên có kích thước 1208x350px.</span>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Banner:</label>
                        <div class="col-sm-10">
                            <div class="input-group"><input id="post_banner" name="banner" type="text" class="form-control" value="<?php echo set_value('banner',$info->banner)?>"> <span class="input-group-btn"><button onclick="open_popup('/public/filemanager/dialog.php?type=1&popup=1&field_id=post_banner&akey=datnguyen2017&relative_url=1&fldr=<?php echo $module;?>/')" type="button" class="btn btn-w-m btn-primary">Tải và Chọn file ảnh từ thư viện</button></span></div>
                            <span>Lưu ý: Hình ảnh nên có kích thước 1208x350px.</span>
                            <?php echo form_error('banner', '<div class="error">', '</div>'); ?>

                            <div><img style="max-width: 300px;" id="post_banner_thumb" alt="" src="<?php echo base_url('public/userfiles/'.$info->banner);?>" alt="" /></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="video" value="<?php echo set_value('video',$info->video)?>" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea id="news" name="content" rows="10" class="form-control"><?php echo set_value('content',$info->content)?></textarea>
