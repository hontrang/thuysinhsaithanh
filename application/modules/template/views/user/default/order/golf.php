            ...
            <div class="col-md-12 tour-item listing-item">
                ...
                <div class="col-md-9">
                            <span class="thumb-info-caption-text">
                                <a href="/golf/chi-tiet/<?php echo $info->slug;?>-<?php echo $info->id;?>.html"><h5 class="mb-xs tour-title"><?php echo $info->name;?></h5></a>
                                <div class="tour-vote">
                                    <div></div>
...
<strong><?php echo round($info->vote_point*5);?>/5</strong> điểm trong <strong><?php echo $info->vote;?></strong> đánh giá</div>
                                ...
                                <div class="info">
                                    <div class="col-md-10 paddding-left-0">
                                        <div class="col-md-6 paddding-left-0">Số lỗ: <strong><?php echo $info->slot;?></strong></div>
                                        <div class="col-md-6 paddding-left-0">Diện tích: <strong><?php echo $info->size;?></strong></div>
                                    </div>
                                    <div class="col-md-2 tour-price-box">
                                        <div class="tour-price"><?php echo ($info->price);?></div>
                                        <div class="tour-view"><a class="btn btn-primary" href="/golf/chi-tiet/<?php echo $info->slug;?>-<?php echo $info->id;?>.html">Xem chi tiết</a></div>
                                    </div>
                                </div>
                            </span>
                </div>
