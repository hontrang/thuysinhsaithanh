...
<input type="hidden" name="cat" value="<?php echo $cat->id;?>" id="cat_id" />
<input type="hidden" name="cats" value="<?php echo implode(",",$cats);?>" id="cats_id" />
    ...
    <div class="row">
        ...
        <div class="col-md-9 pull-right-mobile">
            <div class="section-product product-list">
				<div class="cat-des" style="padding:5px;">
						<h2 class="tit-cat"><?php echo $title;?> </h2>
                    ...
                    ?>
                        ...
                        <div class="p-item item">
                            ...
                            <div class="p-image">
                                ...
                                <h3 style="margin:0px;"><a href="/san-pham/<?php echo $item->slug;?>-<?php echo $item->id;?>.html" class="p-name"><?php echo $item->name;?></a></h3>
                                <div class="p-price">
				...
				<hr>
				<div class="content-text content" style="background: #fff;"><?php echo $detail;?></div>
                <style>
					.content-text{
					max-height: 150px;
					overflow: hidden;
