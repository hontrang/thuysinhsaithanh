                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="post-content">
                                ...
                                <h4><a href="/faq/<?php echo $item->slug;?>.html"><?php echo $item->name;?></a></h4>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="post-meta">
                                ...
                                <span><i class="fa fa-tag"></i> <a href="/faq.html">FAQ</a></span>
                                <span><i class="fa fa-comments"></i> <a href="#">0 Bình luận</a></span>
                                <a href="/faq/<?php echo $item->slug;?>.html" class="btn btn-xs btn-primary pull-right">Xem thêm...</a>
                            </div>
                        </div>
                    </div>
