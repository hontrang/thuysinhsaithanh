                                    ...
                                    <li>
                                        <div class="post-image">
                                            <div class="img-thumbnail">
                                                <a title="<?php echo $item->name;?>" href="/con-nguoi-su-kien/<?php echo $item->slug;?>">
                                                    <img src="<?php echo base_url('public/small/'.$item->image);?>" alt="<?php echo $item->name;?>">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="post-info">
                                            <a title="<?php echo $item->name;?>" href="/con-nguoi-su-kien/<?php echo $item->slug;?>"><?php echo $item->name;?></a>
                                            <div class="post-meta">
